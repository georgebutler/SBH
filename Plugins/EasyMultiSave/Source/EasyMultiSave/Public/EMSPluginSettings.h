...
public:
	...
	*/
	UPROPERTY(config, EditAnywhere, AdvancedDisplay, Category = "Save and Load", meta = (DisplayName = "Compression Method", EditCondition = "FileSaveMethod == EFileSaveMethod::FM_Desktop"))
